...
public class JdbcUserRepository implements UserRepository {
    ...
    public Collection<User> getMutualFriends(Long firstUserId, Long secondUserId) {
        String sqlQuery = "SELECT u.* " +
                "FROM \"user\" u " +
                "JOIN \"user_user_friend\" f1 ON u.\"user_id\" = f1.\"friend_id\" AND f1.\"user_id\" = :first_user_id " +
                "JOIN \"user_user_friend\" f2 ON u.\"user_id\" = f2.\"friend_id\" AND f2.\"user_id\" = :second_user_id;";
